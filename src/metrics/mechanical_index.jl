...
calc_mechanical_index(pressure::PressureArray{2}, excitation) =
    Metric{MI, 1}(mechanical_index_helper(pressure, excitation))

calc_mechanical_index(pressure::PressureArray{3}, excitation) =
    Metric{MI, 2}(mechanical_index_helper(pressure, excitation))

calc_mechanical_index(pressure::PressureArray{4}, excitation) =
